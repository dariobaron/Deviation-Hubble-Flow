...
PYBIND11_MODULE(topographicmap, m) {
	...
	py::class_<TopographicMap>(m, "TopographicMap")
		.def(py::init<double, double, double, double, unsigned, unsigned, double>(), py::arg("inf_x"), py::arg("sup_x"), py::arg("inf_y"), py::arg("sup_y"), py::arg("N_x"), py::arg("N_y"), py::arg("sigma_sep")=0.5)
