...
private:
	TopographicMap tm_;
	HomogeneousMixtureDensity<KernelTypeHomoMixture> md_;
	HomoParametersTransform<KernelTypeHomoMixture> pt_;
	arma::mat W_;
public:
	OtherModel(TopographicMap tm, HomogeneousMixtureDensity<KernelTypeHomoMixture> md) : tm_(tm), md_(md), pt_(md.nComponents()) {};
